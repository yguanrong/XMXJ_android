...
public class DangerCompanyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_danger_company);
        initView();
    }
    ...
    public void initView(){
        ...
        webView.loadUrl("file:///android_asset/views/dangerCompany.html");//加载web页面
    ...
    public void initData(){
        webView.loadUrl("javascript:seteData('"+DBUtils.api+"')");
    }
